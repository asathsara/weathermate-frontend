...
export default function Login() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-100 via-blue-50 to-white">
            ...
            >
                <h2 className="text-3xl font-bold text-center text-sky-500 mb-2">
                    Welcome Back
                </h2>
                ...
                <button
                    ...
                    className="bg-blue-600 hover:bg-blue-700 text-white font-semibold p-4 rounded-xl shadow-md transition duration-300 disabled:opacity-50"
                >
